...
for(var i=0;i<document.querySelectorAll(".piano").length;i++){
  ...
  function makesound(keys){
	...
	tom.play();
	  ...
	  break;
	  case "2":
	  var tom3 = new Audio('2.mp3.wav');
	  tom3.play();
	  break;
	  case "E":
	  var tom4 = new Audio('E.mp3.wav');
	  tom4.play();
	  break;
	  case "3":
	  var tom5 = new Audio('3.mp3.wav');
	  tom5.play();
	  break;
	  case "F":
	  var tom6 = new Audio('F.mp3.wav');
	  tom6.play();
	  break;
	  case "4":
	    var tom7 = new Audio('4.mp3.wav');
		tom7.play();
		break;
		case "G":
			var tom8 = new Audio('G.mp3.wav');
			tom8.play();
			break;
		case "5":
			var tom9 = new Audio('5.mp3.wav');
			tom9.play();
			break;
		case "A":
			var tom10 = new Audio('A.mp3.wav');
			tom10.play();
			break;
		
			case "6":
				var tom11 = new Audio('6.mp3.wav');
				tom11.play();
				break;
			case "B":
				...
				break;
			case "7":
				var tom13 = new Audio('7.mp3.wav');
				tom13.play();
				break;
			case "W":
				var tom14 = new Audio('W.mp3.wav');
				tom14.play();
				break;
			case "8":
				var tom15 = new Audio('8.mp3.wav');
				tom15.play();
				break;
			case "S":
				var tom16 = new Audio('S.mp3.wav');
				tom16.play();
				break;
			case "9":
				var tom17 = new Audio('9.mp3.wav');
				tom17.play();
				break;
			case "R":
				var tom18 = new Audio('R.mp3.wav');
				tom18.play();
				break;
			case "0":
				var tom19 = new Audio('0.mp3.wav');
				tom19.play();
				break;
			case "T":
				var tom20 = new Audio('T.mp3.wav');
				tom20.play();
				break;
	default:
